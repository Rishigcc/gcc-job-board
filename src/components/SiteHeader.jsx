      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3">
        ...
        <div className="hidden shrink-0 items-center gap-1 sm:flex">
          ...
          {navItems.map((item) => {
            ...
            const className =
              "flex items-center gap-1.5 rounded-full px-3 py-2 text-sm font-semibold text-slate-600 transition hover:bg-slate-100";
          ...
          <div className="absolute right-0 top-0 flex h-full w-72 max-w-[80vw] flex-col bg-white p-5 shadow-xl">
            ...
            <div className="mt-6 flex flex-col gap-1">
              {navItems.map((item) => {
                ...
                const className =
                  "flex items-center gap-3 rounded-xl px-4 py-3 text-left text-sm font-semibold text-slate-600 transition hover:bg-slate-100";
